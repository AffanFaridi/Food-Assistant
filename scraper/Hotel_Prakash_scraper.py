        ...
        while True:
            ...
            for btn in read_more_buttons:
                try:
                    ...
                    pass
            time.sleep(0.5)  # Short sleep to let content expand
    except Exception:
        pass
...
if __name__ == "__main__":
    url = "https://www.zomato.com/roorkee/hotel-prakash-restaurant-roorkee-locality/order"
    scrape_zomato_menu(url, "hotel_prakash_roorkee_menu.csv")
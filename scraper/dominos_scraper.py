...
def scrape_dominos_zomato():
    url = "https://www.zomato.com/roorkee/dominos-pizza-roorkee-locality/order"
    ...
    df.to_csv("dominos_roorkee_menu.csv", index=False)
    print("Saved to dominos_roorkee_menu.csv")

if __name__ == "__main__":
    scrape_dominos_zomato()

...
def scrape_zomato_menu(url, output_csv):
    ...
    driver.get(url)
    time.sleep(4)  # added sleep to completely load the page

    # trying to click all the read buttons at once
    try:
        while True:
...
if __name__ == "__main__":
    url = "https://www.zomato.com/roorkee/pizza-hut-roorkee-locality/order"
    scrape_zomato_menu(url, "pizzahut_roorkee_menu.csv")